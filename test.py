...
if __name__ == '__main__':
    ...
    # lightning trainer
    logger = TensorBoardLogger(save_dir='logs/tb_logs_test', name=args.exp_name, default_hp_metric=False)
    trainer = pl.Trainer.from_argparse_args(args, replace_sampler_ddp=False, logger=logger)
